...
- 🎯 Entry points to execute your program using `python -m <pept_gui>` or `$ pept_gui` with basic CLI argument parsing.
...
Awesome pept_gui created by dwerner95
...
```py
from pept_gui import BaseClass
from pept_gui import base_function
