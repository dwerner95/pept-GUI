...
class Cutpoints(QDialog):
    ...
    def ok_button_clicked(self):
        ...
        time_ = time.time()
        self.parent.pept_pipeline[f'Cutpoints_{time_}'] = {"function": tracking.Cutpoints,"name": "tracking.Cutpoints", "kwargs":{"max_distance": max_distance},"update": True, "skip": False}
