...
class Segregate(QDialog):
    def __init__(self, parent=None):
        ...
        loadUi(os.path.join(here, "..", "ui", "segregate.ui"), self)
    ...
    def ok_button_clicked(self):
        ...
        time_ = time.time()
        self.parent.pept_pipeline[f"Segregate_{time_}"] = {
            "function": tracking.Segregate,
            "name": "tracking.Segregate",
            "kwargs": {
                "window": window,
                "cut_distance": cut_distance,
                "min_trajectory_size": min_traj_size,
            },
            "update": True,
            "skip": False,
        }
